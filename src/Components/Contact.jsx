...
const Contact = () => {
  return (
    <div className="flex justify-center items-center ">
      <form name="contact" netlify className="bg-white dark:bg-gray-800 p-8 rounded-lg shadow-lg min-w-[400px] mt-30" >
        ...
        <div className="mb-4">
          ...
          <input
            ...
            className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:text-white"
          />
        </div>
