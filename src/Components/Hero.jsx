...
const Hero = () => {
  ...
  const about_me = `I am a passionate Java Full Stack Developer with hands-on experience
          ...
          specialize in developing scalable applications, RESTful APIs, and
  ...
  return (
    <div className="z-0 relative flex flex-col items-center justify-center h-full p-4">
      ...
      <div>
        <img
          className="mt-20 w-40 h-40 rounded-full border-4 border-white shadow-xl"
          src={dp}
          alt="Profile"
        />
      </div>
      ...
      <div className="max-w-[1000px] text-center mt-4 dark:text-white">
        ...
        <div className="flex flex-row justify-center align-centert mt-4 gap-4 ">
          ...
          <a href="https://github.com/girdharikrthakur"><img className="w-12 h-12 rounded-full dark:bg-white text-white hover:scale-110 transition duration-300 ease-in-outk" src={git} alt="git link" /></a>
        ...
        <p className="mt-8 p-4 text-lg font-normal leading-7 text-justify ">
          {about_me}
        </p>
      </div>
    </div>
